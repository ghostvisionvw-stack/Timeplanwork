...
async def create_contact(
    ...
    try:
        ...
        send_contact_notification(nom=nom, email=email, sujet=sujet, message=message)
    except Exception as e:
        logger.error(f"[CONTACT] Echec envoi notification email : {e}")
        # On ne bloque pas : le message est déjà sauvegardé en DB
